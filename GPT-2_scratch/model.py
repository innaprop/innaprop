...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, optimizer_name, weight_decay, learning_rate, betas, rho, alpha, beta, sigma, device_type):
        """
        ...
        elif optimizer_name == 'innaprop':
            optimizer = opt_func(optim_groups, lr=learning_rate, alpha=alpha, beta=beta, sigma=sigma) 
        else:
